...
class challengeboardView(APIView):
    ...
    def get(self, request, id=None, format=None):
        """
        Gets all challengeboards or gets one  challengeboard via challengeboards/:id
        """
        # If challengeboard id was requested return that challengeboard else return list of all challengeboards
        if id:
            ...
            # Retrieve and serialize the categories in the challenge board
            ...
            # Retrieve and serialize the serialized challengeboard data
